        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ route('teacher') }}" class="nav-item nav-link active"><i
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="{{ route('show_student') }}" class="dropdown-item">Students Detail</a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                                class="fa fa-user me-2"></i>Attendence</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{ route('student_attendence') }}" class="dropdown-item">Student Attendence</a>
                            <a href="{{ route('display_student_attendence') }}" class="dropdown-item">Show Student
                                Attendence</a>
                            <!-- <a href="element.html" class="dropdown-item">Other Elements</a> -->
                        </div>
                    </div>
